...
const appCloseIcon = document.querySelector(".app-close-icon");

const remove = function () {
  modalIcons.classList.remove("hidden");
  appCloseIcon.classList.remove("hidden");
};

appIconShare.addEventListener("click", remove);
appCloseIcon.addEventListener("click", function () {
  modalIcons.classList.add("hidden");
  appCloseIcon.classList.add("hidden");
});
